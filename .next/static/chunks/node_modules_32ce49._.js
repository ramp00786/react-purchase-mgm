(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_32ce49._.js", {
...
"[project]/node_modules/ckeditor4-integrations-common/dist/index.esm.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/ckeditor4-react/dist/index.esm.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ckeditor4$2d$integrations$2d$common$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/ckeditor4-integrations-common/dist/index.esm.js [app-client] (ecmascript)");
...
var useEffect$1 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.useEffect, useReducer = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.useReducer, useRef$1 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.useRef;
...
function useCKEditor(_a) {
    ...
    useEffect$1({
        "useCKEditor.useEffect$1": function() {
            if (element && !editor) {
                dispatch({
                    type: 'loading'
                });
                var onNamespaceLoaded = {
                    "useCKEditor.useEffect$1.onNamespaceLoaded": function(CKEDITOR) {
                        var _a;
                ...
                }["useCKEditor.useEffect$1.onNamespaceLoaded"];
                var initEditor = {
                    "useCKEditor.useEffect$1.initEditor": function(CKEDITOR) {
                        var _a;
                        ...
                        var subscribedEditorEvents = subscribeToRef.current.filter({
                            "useCKEditor.useEffect$1.initEditor.subscribedEditorEvents": function(evtName) {
                                return namespaceEvents.indexOf(evtName) === -1;
                            }
                        }["useCKEditor.useEffect$1.initEditor.subscribedEditorEvents"]);
                        subscribedEditorEvents.forEach({
                            "useCKEditor.useEffect$1.initEditor": function(evtName) {
                                registerEditorEventHandler({
                                    debug: debugRef.current,
                                    editor: editor,
                                    evtName: evtName,
                                    handler: {
                                        "useCKEditor.useEffect$1.initEditor": function(payload) {
                                            var _a;
                                            (_a = dispatchEventRef.current) === null || _a === void 0 ? void 0 : _a.call(dispatchEventRef, {
                                    ...
                                    }["useCKEditor.useEffect$1.initEditor"]
                                });
                            }
                        }["useCKEditor.useEffect$1.initEditor"]);
                        registerEditorEventHandler({
                            ...
                            evtName: 'loaded',
                            handler: {
                                "useCKEditor.useEffect$1.initEditor": function() {
                                    dispatch({
                                        type: 'loaded'
                                    });
                                }
                        ...
                        registerEditorEventHandler({
                            ...
                            handler: {
                                "useCKEditor.useEffect$1.initEditor": function(_a) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ckeditor4$2d$integrations$2d$common$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getEditorNamespace"])(editorUrlRef.current, onNamespaceLoaded).then(initEditor).catch({
                    "useCKEditor.useEffect$1": function(error) {
                        if ("TURBOPACK compile-time truthy", 1) {
                            console.error(error);
                        }
                        dispatch({
...
var useEffect = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.useEffect, useRef = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.useRef, useState = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.useState;
function CKEditor(_a) {
    ...
    var _d = useCKEditor({
        ...
        subscribeTo: Object.keys(handlers).filter({
            "CKEditor.useCKEditor[_d]": function(key) {
                return key.indexOf('on') === 0;
            }
        }["CKEditor.useCKEditor[_d]"]).map(handlerNameToEventName),
        type: type
    }), editor = _d.editor, status = _d.status;
    useEffect({
        "CKEditor.useEffect": function() {
            ...
            return ({
                "CKEditor.useEffect": function() {
                    if (style && canSetStyles) {
                        Object.keys(style).map(camelToKebab).forEach({
                            "CKEditor.useEffect": function(styleName) {
...
var propTypes = __assign({
    config: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prop$2d$types$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.object,
    debug: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prop$2d$types$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.bool,
    editorUrl: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prop$2d$types$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.string,
    initData: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prop$2d$types$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.node,
    name: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prop$2d$types$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.string,
    ...
    style: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prop$2d$types$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.object,
    type: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prop$2d$types$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.oneOf([
        'classic',
        'inline'
    ])
}, defaultEvents.reduce(function(acc, key) {
    var _a;
    return __assign(__assign({}, acc), (_a = {}, _a[eventNameToHandlerName(key)] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prop$2d$types$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.func, _a));
}, {}));
...
//# sourceMappingURL=node_modules_32ce49._.js.map